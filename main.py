...
def main():
        ...
        if choice == 'EDA':
            ...
            uploaded_file = st.file_uploader("Upload CSV with Location, Units and Depth as headers", type=".csv")
            ...
            if uploaded_file:
                ...
                if st.checkbox("Regression: Please select Unit first then Y and X"):
                    ...
                    if submitted:
                        ...
                        ax.set_xlabel(y_choice.title())
                        ax.set_ylabel(x_choice.title())
                        ax.xaxis.tick_top()
                        ...
                        axes.scatter(x[mask], new['Y'][mask], facecolor='r', edgecolor='none', alpha=0.3,
                                     label='data point outside', transform=rot + base)
                        axes.scatter(x[~mask], new['Y'][~mask], facecolor='g', edgecolor='none', alpha=0.3,
                        ...
                        axes.set_xlabel(y_choice.title())
                        axes.set_ylabel(x_choice.title())
